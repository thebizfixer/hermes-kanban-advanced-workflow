...
def setup_argparse(subparser: argparse.ArgumentParser) -> None:
    ...
    init.add_argument("--trigger-branch", default="production", help="CI/CD trigger branch (operator-only merges)")
...
def _handle_init(args) -> int:
    ...
    print(f"  Trigger branch: {args.trigger_branch}")
    print()
...
coding_agent_binary: {coding_binary}
bundle_path: {PLUGIN_ROOT}
skills_output_path: {hermes_home / 'skills' / 'kanban-advanced'}

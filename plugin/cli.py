...
""")
    ...
    if errors:
        ...
        print()
        print("  Next steps:")
        print(f"    1. Start gateway: hermes gateway start")
        print(f"    2. Create cron jobs (see kanban-advanced README)")
        print(f"    3. Decompose a plan: hermes kanban-advanced decompose --plan <file>")
        return 0
